...
#if !defined (MIRYOKU_LAYOUTMAPPING_PIANTOR_PRO_BT_5COL)

#define MIRYOKU_LAYOUTMAPPING_PIANTOR_PRO_BT_5COL( \
...
#define MIRYOKU_MAPPING MIRYOKU_LAYOUTMAPPING_PIANTOR_PRO_BT_5COL
